...
import '../models/related_ads_model.dart';

class RelatedAdsGridView extends StatelessWidget {
  const RelatedAdsGridView({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: GridView.builder(
        ...
        itemCount: relatedAdsModel.length,
        itemBuilder: (BuildContext context, int index) {
          RelatedAdsModel ads = relatedAdsModel[index];
